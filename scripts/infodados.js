        document.addEventListener('DOMContentLoaded', function() {
            ...
            async function loadUFs() {
                ...
                try {
                    ...
                    ufGroup.appendChild(showError('Não foi possível carregar a lista de estados. Tente novamente mais tarde.'));
                } finally {
            ...
            async function loadMunicipios(uf) {
                ...
                try {
                    ...
                    municipioGroup.appendChild(showError('Não foi possível carregar a lista de municípios. Tente novamente mais tarde.'));
                } finally {
